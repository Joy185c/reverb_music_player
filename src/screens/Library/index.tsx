        ...
        {activeTab === 'Songs' ? (
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  {item.isFavorite && <Text className="text-accent ml-2">❤️</Text>}
                </TouchableOpacity>
              )}
              ListEmptyComponent={
          ...
          <View className="flex-1">
            <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity className="w-[48%] aspect-square bg-surface rounded-2xl mb-4 p-4 justify-end">
                  <Text className="text-primaryText font-bold text-lg" numberOfLines={2}>{item.name}</Text>
                  <Text className="text-secondaryText text-sm mt-1">0 songs</Text>
                </TouchableOpacity>
              )}
              ListEmptyComponent={
